...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommissionType', function() {
      beforeEach(function() {
        instance = BtcTurkAp30.CommissionType;
      });

      it('should create an instance of CommissionType', function() {
        // TODO: update the code to test CommissionType
