...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AlarmVector', function() {
      beforeEach(function() {
        instance = BtcTurkAp30.AlarmVector;
      });

      it('should create an instance of AlarmVector', function() {
        // TODO: update the code to test AlarmVector
