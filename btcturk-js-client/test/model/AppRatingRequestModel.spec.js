...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppRatingRequestModel', function() {
      beforeEach(function() {
        instance = new BtcTurkAp30.AppRatingRequestModel();
      });

      it('should create an instance of AppRatingRequestModel', function() {
        // TODO: update the code to test AppRatingRequestModel
        expect(instance).to.be.a(BtcTurkAp30.AppRatingRequestModel);
      });
