...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DocumentFileType', function() {
      beforeEach(function() {
        instance = BtcTurkAp30.DocumentFileType;
      });

      it('should create an instance of DocumentFileType', function() {
        // TODO: update the code to test DocumentFileType
