...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppRatingEnum', function() {
      beforeEach(function() {
        instance = BtcTurkAp30.AppRatingEnum;
      });

      it('should create an instance of AppRatingEnum', function() {
        // TODO: update the code to test AppRatingEnum
