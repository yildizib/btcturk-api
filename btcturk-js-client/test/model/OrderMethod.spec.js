...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderMethod', function() {
      beforeEach(function() {
        instance = BtcTurkAp30.OrderMethod;
      });

      it('should create an instance of OrderMethod', function() {
        // TODO: update the code to test OrderMethod
