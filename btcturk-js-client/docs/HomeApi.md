...
let apiInstance = new BtcTurkAp30.HomeApi();
apiInstance.apiResourcesLanguageGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> apiResourcesLanguageJsonGet(language, opts)
...
apiInstance.apiResourcesLanguageJsonGet(language, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new BtcTurkAp30.HomeApi();
apiInstance.apiResourcesLocationGet((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
