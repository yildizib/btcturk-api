...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BankLimit :  IEquatable<BankLimit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankLimit" /> class.
        /// </summary>
        /// <param name="minDepositAmount">minDepositAmount.</param>
        /// <param name="minWithdrawalAmounts">minWithdrawalAmounts.</param>
        public BankLimit(double? minDepositAmount = default(double?), double? minWithdrawalAmounts = default(double?))
        {
        ...
        {
            return this.Equals(input as BankLimit);
        }

        /// <summary>
        /// Returns true if BankLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of BankLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankLimit input)
        {
            if (input == null)
                return false;
