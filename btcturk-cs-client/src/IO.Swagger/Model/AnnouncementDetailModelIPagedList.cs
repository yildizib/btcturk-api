...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AnnouncementDetailModelIPagedList :  IEquatable<AnnouncementDetailModelIPagedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnouncementDetailModelIPagedList" /> class.
        /// </summary>
        public AnnouncementDetailModelIPagedList()
        {
        }
        ...
        public List<AnnouncementDetailModel> Items { get; private set; }
        ...
        {
            return this.Equals(input as AnnouncementDetailModelIPagedList);
        }

        /// <summary>
        /// Returns true if AnnouncementDetailModelIPagedList instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnouncementDetailModelIPagedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnouncementDetailModelIPagedList input)
        {
            if (input == null)
                return false;
