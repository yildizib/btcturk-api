...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PaparaCommissionOutputModel :  IEquatable<PaparaCommissionOutputModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaparaCommissionOutputModel" /> class.
        /// </summary>
        ...
        /// <param name="withdrawalMaxFee">withdrawalMaxFee.</param>
        /// <param name="withdrawalTax">withdrawalTax.</param>
        /// <param name="minimumWithdrawalPerTransaction">minimumWithdrawalPerTransaction.</param>
        public PaparaCommissionOutputModel(double? depositFee = default(double?), int? depositMaxFee = default(int?), double? depositTax = default(double?), double? withdrawalFee = default(double?), int? withdrawalMaxFee = default(int?), double? withdrawalTax = default(double?), double? minimumWithdrawalPerTransaction = default(double?))
        {
        ...
        /// <summary>
        /// Gets or Sets WithdrawalMaxFee
        /// </summary>
        [DataMember(Name="withdrawalMaxFee", EmitDefaultValue=false)]
        public int? WithdrawalMaxFee { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MinimumWithdrawalPerTransaction
        /// </summary>
        [DataMember(Name="minimumWithdrawalPerTransaction", EmitDefaultValue=false)]
        public double? MinimumWithdrawalPerTransaction { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WithdrawalMaxFee: ").Append(WithdrawalMaxFee).Append("\n");
            sb.Append("  WithdrawalTax: ").Append(WithdrawalTax).Append("\n");
            sb.Append("  MinimumWithdrawalPerTransaction: ").Append(MinimumWithdrawalPerTransaction).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PaparaCommissionOutputModel);
        }

        /// <summary>
        /// Returns true if PaparaCommissionOutputModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PaparaCommissionOutputModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaparaCommissionOutputModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WithdrawalMaxFee == input.WithdrawalMaxFee ||
                    (this.WithdrawalMaxFee != null &&
                    this.WithdrawalMaxFee.Equals(input.WithdrawalMaxFee))
                ) && 
                (
                ...
                (
                    this.MinimumWithdrawalPerTransaction == input.MinimumWithdrawalPerTransaction ||
                    (this.MinimumWithdrawalPerTransaction != null &&
                    this.MinimumWithdrawalPerTransaction.Equals(input.MinimumWithdrawalPerTransaction))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WithdrawalMaxFee != null)
                    hashCode = hashCode * 59 + this.WithdrawalMaxFee.GetHashCode();
                if (this.WithdrawalTax != null)
                    hashCode = hashCode * 59 + this.WithdrawalTax.GetHashCode();
                if (this.MinimumWithdrawalPerTransaction != null)
                    hashCode = hashCode * 59 + this.MinimumWithdrawalPerTransaction.GetHashCode();
                return hashCode;
            }
        }
