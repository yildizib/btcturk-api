...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AnnouncementModelIPagedList :  IEquatable<AnnouncementModelIPagedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnouncementModelIPagedList" /> class.
        /// </summary>
        public AnnouncementModelIPagedList()
        {
        }
        ...
        public List<AnnouncementModel> Items { get; private set; }
        ...
        {
            return this.Equals(input as AnnouncementModelIPagedList);
        }

        /// <summary>
        /// Returns true if AnnouncementModelIPagedList instances are equal
        /// </summary>
        /// <param name="input">Instance of AnnouncementModelIPagedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnnouncementModelIPagedList input)
        {
            if (input == null)
                return false;
