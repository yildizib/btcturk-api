...
class TestExchangeApi(unittest.TestCase):
    ...
    def test_api_v3_exchange_commissions_get(self):
        """Test case for api_v3_exchange_commissions_get

        """
        pass

    def test_api_v3_exchange_limits_get(self):
        """Test case for api_v3_exchange_limits_get
